...
hand_vec[1] = cards.card("2 of Spades", 2)
hand_vec[2] = cards.card("6 of Hearts", 6)
hand_vec[3] = cards.card("3 of Clubs", 3)
hand_vec[4] = cards.card("5 of Spades", 5)
hand_vec[5] = cards.card("4 of Diamonds", 4)
hand_vec[6] = cards.card("7 of Clubs", 7)
test_vec = cards.sortHand(hand_vec)

best_score = cards.flush(test_vec)
